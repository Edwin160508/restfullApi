...
var routes_1 = require("./models/user/routes");
var App = /** @class */ (function () {
    ...
    App.prototype.routes = function () {
        this.app.route('/').get(function (req, res) { return res.status(200).json({ 'message': 'Olá Mundo!' }); });
        this.app.route('/test').get(function (req, res) { return res.status(200).json({ 'message': 'Olá Mundo!' }); });
